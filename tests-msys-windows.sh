...
## WINDOWS Notes: 
##   This script can run using MSYS2. 
##   - install `diffutils` package with `pacman -S diffutils`
##   - set the path of `openssl`


# simple round-trip tests to verify the tool

# path of ssh-keygen
sskkeygen="/C/Windows/System32/OpenSSH/ssh-keygen.exe"
